...
final class RoundTests: XCTestCase {
    ...
    func test_assignScore_retreive() {
        ...
        round.addPlayers(player1, player2)
    ...
    // TODO: - Rewrite tests for missing // null players & score
...
//    }
    ...
    func test_equality() {
        ...
        round1.addPlayers(player1, player2)
        round2.addPlayers(player1, player2)
        round3.addPlayers(player1, player2)
